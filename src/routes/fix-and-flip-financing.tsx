...
import image from "@/assets/specialty-flip.jpg";

const solution = specialtyBySlug("fix-and-flip-financing")!;

export const Route = createFileRoute("/fix-and-flip-financing")({
  head: () => ({
