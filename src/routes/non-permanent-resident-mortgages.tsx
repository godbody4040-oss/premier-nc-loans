...
import image from "@/assets/specialty-residents.jpg";

const solution = specialtyBySlug("non-permanent-resident-mortgages")!;

export const Route = createFileRoute("/non-permanent-resident-mortgages")({
  head: () => ({
