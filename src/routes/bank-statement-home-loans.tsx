...
import image from "@/assets/specialty-bank-statement.jpg";

const solution = specialtyBySlug("bank-statement-home-loans")!;

export const Route = createFileRoute("/bank-statement-home-loans")({
  head: () => ({
