...
import image from "@/assets/specialty-rental.jpg";

const solution = specialtyBySlug("rental-property-financing")!;

export const Route = createFileRoute("/rental-property-financing")({
  head: () => ({
